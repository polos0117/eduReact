...
function TodoFooter({ total, done, filter, archivedCount, onArchiveCompleted, onShowArchived, onRestoreAll, onClearArchived }) {
            ...
            <div className="todo-footer-row">
                ...
                <span className="todo-footer-actions">
                    {archive
                        ? (
                            <>
                                <button type="button" className="link-btn" onClick={onRestoreAll} disabled={total === 0}>모두 복원</button>
