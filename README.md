...
- 스킨 아홉 가지 — 설정의 미리보기 카드에서 선택. 스킨마다 서체·재질·모양이 다릅니다
...
밤·네오·터미널·청사진은 어두운 톤 전용이라 그 상태에서는 테마 선택이 숨겨집니다. 나머지는 라이트/다크 모두 됩니다.
...
src/
  ...
  skins.css                 종이·수묵·말랑·밤·터미널·청사진·고대비 — 토큰 + 스킨마다의 서체·재질·모양
  hooks/
