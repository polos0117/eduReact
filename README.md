...
- 스킨 다섯 가지 — 머리글 ◈ 드롭다운에서 선택. 색 토큰만 갈아끼우는 구조라 하나 더 만드는 비용이 작습니다

| 클래식 | 종이 | 네오 | 터미널 | 고대비 |
|---|---|---|---|---|
| 흰 시트, 헤어라인 | 크림색 종이, 세리프 제목 | 우주 배경, 유리 패널, 네온 | 초록 인광, 고정폭, 각진 모서리 | 순흑백, 굵은 선, 큰 포커스 링 |

![종이](docs/skin-paper.png)
![터미널](docs/skin-terminal.png)
![고대비](docs/skin-contrast.png)
...
src/
  ...
  skins.css                 종이·터미널·고대비 — 색 토큰만 갈아끼우는 가벼운 스킨들
  hooks/
